...
import (
	...
	qgbcmd "github.com/elysiumorg/elysium-app/x/qgb/client"
...
const EnvPrefix = "ELYSIUM"

// NewRootCmd creates a new root command for elysium-appd. It is called once in the
// main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			// Override the default tendermint config for elysium-app
			tmCfg := tmcfg.DefaultConfig()

			// Set broadcast timeout to be 50 seconds in order to avoid timeouts for long block times
			// TODO: make TimeoutBroadcastTx configurable per https://github.com/elysiumorg/elysium-app/issues/1034
...
func initAppConfig() (string, interface{}) {
	...
	ElysiumAppCfg := CustomAppConfig{Config: *srvCfg}

	ElysiumAppTemplate := serverconfig.DefaultConfigTemplate

	return ElysiumAppTemplate, ElysiumAppCfg
}
