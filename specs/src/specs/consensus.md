...
| `CHAIN_ID`                              | `string` | `"Elysium"` |         | Chain ID. Each chain assigns itself a (unique) ID.                                                                                                                  |
...
| `VERSION_APP`                           | `uint64` | `1`          |         | Version of the Elysium application. Breaking changes (hard forks) must update this parameter.                                                                      |
| `VERSION_BLOCK`                         | `uint64` | `1`          |         | Version of the Elysium chain. Breaking changes (hard forks) must update this parameter.                                                                            |
