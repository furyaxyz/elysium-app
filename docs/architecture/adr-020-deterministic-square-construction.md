...
- By staging transactions in order of priority, we prevent the removal of a higher priority transaction that had a higher namespace than a transaction with a lower namespace and lower priority. [#1519](https://github.com/furyaxyz/elysium-app/issues/1519)
...
- Block proposers can no longer run forks of elysium-app that make optimizations to the square layout. Optimizations have to be funneled through the canonical implementation.
...
- [PoC: iterative and deterministic square construction](https://github.com/furyaxyz/elysium-app/pull/1301)
