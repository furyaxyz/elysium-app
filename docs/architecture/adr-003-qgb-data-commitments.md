...
Data commitment messages attest that a certain set of blocks have been committed to in the Elysium chain. These commitments are used to update the data commitment checkpoint defined in the Ethereum smart contract of the QGB.
