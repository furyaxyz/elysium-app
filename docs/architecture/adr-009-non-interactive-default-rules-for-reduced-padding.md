...
> **Note**
> This analysis assumes the implementation of [elysium-app#1004](https://github.com/furyaxyz/elysium-app/issues/1004). If the tree over the subtree roots is not a Namespace Merkle Tree then both methods have the same proof size.
...
[Related Question](https://github.com/furyaxyz/elysium-app/blob/main/docs/architecture/adr-008-square-size-independent-message-commitments.md#positive-elysium-app-changes)
