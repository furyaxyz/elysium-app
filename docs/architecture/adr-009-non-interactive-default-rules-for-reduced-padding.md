...
> **Note**  
> This analysis assumes the implementation of [elysium-app#1004](https://github.com/elysiumorg/elysium-app/issues/1004). If the tree over the subtree roots is not a Namespace Merkle Tree then both methods have the same proof size.
...
The node needs to be part of the commitment generation **and** part of the Merkle tree to the DataRoot for the trick to work. The diagram shows a Elysium square that is erasure coded and those parity shares are marked in green.
...
[Related Question](https://github.com/elysiumorg/elysium-app/blob/main/docs/architecture/adr-008-square-size-independent-message-commitments.md#positive-elysium-app-changes)
