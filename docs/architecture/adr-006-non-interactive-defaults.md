...
please see the [original specs](https://github.com/furyaxyz/elysium-specs/blob/e59efd63a2165866584833e91e1cb8a6ed8c8203/src/rationale/message_block_layout.md), from which this ADR paraphrases heavily.
...
- Refactor share splitting and merging to use the above metadata when decoding and encoding the square. [#462](https://github.com/furyaxyz/elysium-core/issues/462) [#819](https://github.com/furyaxyz/elysium-core/pull/819) [#637](https://github.com/furyaxyz/elysium-app/pull/637)
- Implement the non-interactive default logic. [#680](https://github.com/furyaxyz/elysium-app/pull/680)
- Implement the ability to traverse nmt tree to find subtree roots. [#621](https://github.com/furyaxyz/elysium-app/pull/621) [#545](https://github.com/furyaxyz/elysium-app/pull/549) [#681](https://github.com/furyaxyz/elysium-app/pull/681)
- Refactor `PrepareProposal` to arrange the shares such that each message has the appropriate subtree roots, and so that the metadata connection between transactions and messages is correct. [#692](https://github.com/furyaxyz/elysium-app/pull/692)
- Refactor `ProcessProposal` to check for message inclusion using only subtree roots to row roots. [#747](https://github.com/furyaxyz/elysium-app/pull/747)

### Add metadata to wrapped transactions [#819](https://github.com/furyaxyz/elysium-core/pull/819)
...
We are already wrapping/unwrapping malleated transactions, so including the `share_index` as metadata using the current code is essentially as simple as adding the `share_index` to the struct. Transactions are unwrapped selectively by using a [`MalleatedTxDecoder(...)`](https://github.com/furyaxyz/elysium-app/blob/5ac236fb1dab6628e98a505269f295c18e150b27/app/encoding/malleated_tx_decoder.go#L8-L15) or by using the [`UnwrapMalleatedTx(...)`](https://github.com/furyaxyz/elysium-core/blob/212901fcfc0f5a095683b1836ea9e890cc952dc7/types/tx.go#L214-L237) function.
