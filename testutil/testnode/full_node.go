...
import (
	...
	"github.com/elysiumorg/elysium-app/x/version"
)

// New creates a ready to use tendermint node that operates a single validator
// elysium-app network using the provided genesis state. The provided keyring
...
// DefaultNetwork creates an in-process single validator elysium-app network
