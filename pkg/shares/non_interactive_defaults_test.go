...
func TestNextMultipleOfBlobMinSquareSize(t *testing.T) {
	...
	tests := []test{
		...
		{
			// inspired by the diagram at https://github.com/elysiumorg/elysium-app/blob/1b80b94a62c8c292f569e2fc576e26299985681a/docs/architecture/adr-009-non-interactive-default-rules-for-reduced-padding.md?plain=1#L30
