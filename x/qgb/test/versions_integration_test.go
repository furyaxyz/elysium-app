...
import (
	...
	"github.com/elysiumorg/elysium-app/x/qgb"
	qgbtypes "github.com/elysiumorg/elysium-app/x/qgb/types"
	v1 "github.com/elysiumorg/elysium-app/x/qgb/v1"
	"github.com/elysiumorg/elysium-app/x/qgb/v1beta1"
...
func createValidator(cctx testnode.Context, ecfg encoding.Config, account string, delegation int64) error {
	...
	msg, err := stakingtypes.NewMsgCreateValidator(
		...
		stakingtypes.NewDescription("taco tuesday", "my keybase", "www.elysium.org", "ping @elysiumorg on twitter", "fake validator"),
