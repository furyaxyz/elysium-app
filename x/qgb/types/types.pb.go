...
// source: elysium/qgb/v1/types.proto
...
type Valset struct {
	...
	// https://github.com/elysiumorg/elysium-app/pull/464
...
func init() {
	proto.RegisterType((*BridgeValidator)(nil), "elysium.qgb.v1.BridgeValidator")
	proto.RegisterType((*Valset)(nil), "elysium.qgb.v1.Valset")
	proto.RegisterType((*DataCommitment)(nil), "elysium.qgb.v1.DataCommitment")
}

func init() { proto.RegisterFile("elysium/qgb/v1/types.proto", fileDescriptor_5db0e6d49b998544) }
