...
import (
	...
	wrapper "github.com/elysiumorg/quantum-gravity-bridge/wrappers/QuantumGravityBridge.sol"
...
// SignBytes produces the bytes that elysium validators are required to sign
