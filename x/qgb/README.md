...
The QGB state machine handles the creation of [`AttestationRequestI`](https://github.com/elysiumorg/elysium-app/blob/801a0d412631989ce97748badbd7bb676982db16/x/qgb/types/attestation.go#L15-L23) which can be either a [`DataCommitment`](https://github.com/elysiumorg/elysium-app/blob/801a0d412631989ce97748badbd7bb676982db16/proto/qgb/types.proto#L31-L47) or a [`Valset`](https://github.com/elysiumorg/elysium-app/blob/801a0d412631989ce97748badbd7bb676982db16/proto/qgb/types.proto#L17-L29).
...
The smart contract implementation is in [quantum-gravity-bridge](https://github.com/elysiumorg/quantum-gravity-bridge/).
...
QGB v1 implementation, including the orchestrator and relayer, is in the [qgb-integration](https://github.com/elysiumorg/elysium-app/tree/qgb-integration) branch.

QGB ADRs are in the [docs](https://github.com/elysiumorg/elysium-app/tree/main/docs/architecture).
