...
// KeyringSigner uses a keyring to sign and build elysium-app transactions
...
// NewTxBuilder returns the default sdk Tx builder using the elysium-app encoding config
...
// QueryAccount fetches the account number and sequence number from the elysium-app node.
