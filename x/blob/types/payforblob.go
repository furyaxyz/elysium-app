...
const (
	URLMsgPayForBlobs = "/elysium.blob.v1.MsgPayForBlobs"
...
//
// [Message layout rationale]: https://github.com/elysiumorg/elysium-specs/blob/e59efd63a2165866584833e91e1cb8a6ed8c8203/src/rationale/message_block_layout.md?plain=1#L12
// [Non-interactive default rules]: https://github.com/elysiumorg/elysium-specs/blob/e59efd63a2165866584833e91e1cb8a6ed8c8203/src/rationale/message_block_layout.md?plain=1#L36
func CreateCommitment(blob *Blob) ([]byte, error) {
	...
	// https://github.com/elysiumorg/elysium-app/blob/fbfbf111bcaa056e53b0bc54d327587dee11a945/docs/architecture/adr-008-blocksize-independent-commitment.md
