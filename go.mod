module github.com/elysiumorg/elysium-app

go 1.18

require (
	github.com/elysiumorg/nmt v0.15.0
	github.com/elysiumorg/quantum-gravity-bridge v1.3.0
...
replace (
	...
	github.com/tendermint/tendermint => github.com/elysiumorg/elysium-core v1.15.1-tm-v0.34.23-BSR-hardfork
)
